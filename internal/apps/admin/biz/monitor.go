...
func NewMonitorController(repo MonitorRepo, logger log.Logger) *MonitorController {
	log := log.NewHelper(log.With(logger, "module", "admin/biz/server"))
...
func (e *MonitorController) ServerInfo(c *gin.Context) {
